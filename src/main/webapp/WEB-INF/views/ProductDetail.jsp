				...
				<div class="col-md-8">
					<div class="product-content-right">
						<div class="product-breadcroumb">
							<a href="/">Home</a> <a href=""><%=product.getCategoryName() %></a> <a href=""><%=product.getSubCategoryName() %></a>   <a href=""><%=product.getName()%></a>
						</div>
							...
							<div class="col-sm-6">
								<div class="product-inner">
									...
									<div class="product-inner-category">
										<p>
											Category: <a href=""><%=product.getCategoryName()%></a>.
											SubCategory: <a href=""> <%=product.getSubCategoryName()%></a>
										</p>
									</div>
						...
						<div class="related-products-wrapper">
							...
							<div
								class="related-products-carousel owl-carousel owl-theme owl-responsive-1200 owl-loaded">
								...
								<div class="owl-stage-outer">
									<div class="owl-stage"
										style="transform: translate3d(-770.001px, 0px, 0px); transition: all 0s ease 0s; width: 3080px;">
										<div class="owl-item cloned"
											style="width: 236.667px; margin-right: 20px;">
