									...
									<tbody>
										...
										<tr class="cart_item">
											...
											<td class="product-thumbnail"><a
												href="orderdetails?orderId=<%=c.getOrderId()%>"><%=c.getOrderId()%></a></td>

											<td class="product-name"><%=c.getOrderDate() %></td>

											<td class="product-price"><span class="amount"><%=c.getTotalAmount()%></span>
											</td>
 										<td>
 											<%=c.getAddressLine() %> |
 											<%=c.getCity() %>|
